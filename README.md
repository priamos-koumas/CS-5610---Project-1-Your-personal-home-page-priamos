# Priamos Koumas — Personal Homepage
### CS 5610 Web Development | Project 1
...
- **Resume** — Education, experience, projects and skills (AI Generated)
- **Q&A** — Personal FAQ with interactive accordion and Greek bouzouki music
...
```bash
cd CS-5610---Project-1-Your-personal-home-page
```
...
**Bootstrap & Tutorials:**
- Bootstrap 5 Tutorial — Ziad El Khoury Hanna
...
- Stack Overflow — Glassmorphic Navbar
  https://stackoverflow.com/questions/68605149/how-to-make-glassmorphic-navbar
- YouTube Tutorial — Glassmorphism Effect
  https://www.youtube.com/watch?v=MsioY73mvBI
- YouTube Tutorial — Glassmorphism CSS
  https://www.youtube.com/watch?v=Aj8ef_TbiH8&t=227s
...
**About Me Section:**
- Free Frontend — About Us Section Template
